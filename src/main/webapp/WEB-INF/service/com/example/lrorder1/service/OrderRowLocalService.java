...
/**
 * Provides the local service interface for OrderRow. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OrderRowLocalServiceUtil
...
public interface OrderRowLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OrderRowLocalServiceUtil} to access the order row local service. Add custom service methods to {@link com.example.inventory.service.impl.OrderRowLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OrderRow createOrderRow(long orderRowId);
	...
	*/
	...
	public OrderRow deleteOrderRow(long orderRowId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OrderRow deleteOrderRow(OrderRow orderRow);
	...
	*/
	...
	public OrderRow fetchOrderRow(long orderRowId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OrderRow getOrderRow(long orderRowId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OrderRow> getOrderRows(int start, int end);
