...
package com.example.inventory.service.persistence.impl;

import com.example.inventory.exception.NoSuchProductException;
import com.example.inventory.model.Product;
import com.example.inventory.model.ProductTable;
import com.example.inventory.model.impl.ProductImpl;
import com.example.inventory.model.impl.ProductModelImpl;
...
public class ProductPersistenceImpl
	 ...
	 */
	@Override
	public List<Product> findByCode(
	...
	public List<Product> findByCode(
		...
		if (useFinderCache) {
			list = (List<Product>)dummyFinderCache.getResult(
	...
	public Product[] findByCode_PrevAndNext(
		...
		try {
			...
			array[0] = getByCode_PrevAndNext(
				session, product, code, orderByComparator, true);

			array[1] = product;

			array[2] = getByCode_PrevAndNext(
				session, product, code, orderByComparator, false);
	...
	protected Product getByCode_PrevAndNext(
		Session session, Product product, String code,
	...
	private static final String _FINDER_COLUMN_CODE_CODE_3 =
		"(product.code IS NULL OR product.code = '')";
	...
	public void clearCache() {
		dummyEntityCache.clearCache(ProductImpl.class);

		dummyFinderCache.clearCache(ProductImpl.class);
	}
	...
	public void clearCache(Product product) {
		dummyEntityCache.removeResult(ProductImpl.class, product);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			dummyEntityCache.removeResult(ProductImpl.class, primaryKey);
		}
	}
	...
	public Product updateImpl(Product product) {
		...
		dummyEntityCache.putResult(
			ProductImpl.class, productModelImpl, false, true);
	...
	public void destroy() {
		...
		dummyEntityCache.removeCache(ProductImpl.class.getName());
	}
