 ...
 * <code>com.example.inventory.service.impl.ProductLocalServiceImpl</code> and
...
public class ProductLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.example.inventory.service.impl.ProductLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Product deleteProduct(long id) throws PortalException {
	...
	public static Product fetchProduct(long id) {
	 ...
	 * @throws PortalException if a product with the primary key could not be found
	 */
	public static Product getProduct(long id) throws PortalException {
	...
	public static void setService(ProductLocalService service) {
		_service = service;
	}
